import{c as a,U as n,j as i,m as p}from"./chunks/framework.DQFmIr4R.js";const r=JSON.parse('{"title":"原始载荷格式","description":"","frontmatter":{},"headers":[],"relativePath":"zh/specification/payload.md","filePath":"zh/specification/payload.md","lastUpdated":1782214112000}'),l={name:"zh/specification/payload.md"};function t(e,s,h,k,o,c){return n(),i("div",null,[...s[0]||(s[0]=[p(`<h1 id="原始载荷格式" tabindex="-1">原始载荷格式 <a class="header-anchor" href="#原始载荷格式" aria-label="Permalink to “原始载荷格式”">​</a></h1><p>原始载荷是压缩与混淆之前的二进制数据，根据 Flat 和 ExtInfo 标志位分为三种模式。</p><hr><h2 id="目录树模式-flat-0" tabindex="-1">目录树模式（Flat = 0） <a class="header-anchor" href="#目录树模式-flat-0" aria-label="Permalink to “目录树模式（Flat = 0）”">​</a></h2><p>保留完整目录结构，通过 JSON 元数据描述文件树。</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span>┌──────────────────────────────────────┐</span></span>
