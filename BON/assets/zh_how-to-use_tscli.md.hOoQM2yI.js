import{_ as a,o as n,c as p,ak as e}from"./chunks/framework.D8TdBi6N.js";const h=JSON.parse('{"title":"bon-ts CLI 使用指南","description":"","frontmatter":{},"headers":[],"relativePath":"zh/how-to-use/tscli.md","filePath":"zh/how-to-use/tscli.md","lastUpdated":1782452117000}'),l={name:"zh/how-to-use/tscli.md"};function t(i,s,o,c,d,r){return n(),p("div",null,[...s[0]||(s[0]=[e(`<h1 id="bon-ts-cli-使用指南" tabindex="-1">bon-ts CLI 使用指南 <a class="header-anchor" href="#bon-ts-cli-使用指南" aria-label="Permalink to “bon-ts CLI 使用指南”">​</a></h1><h2 id="安装" tabindex="-1">安装 <a class="header-anchor" href="#安装" aria-label="Permalink to “安装”">​</a></h2><div class="language-bash"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes vitesse-light vitesse-dark" style="background-color:#ffffff;--shiki-dark-bg:#121212;color:#393a34;--shiki-dark:#dbd7caee;" tabindex="0"><code><span class="line"><span># 在 monorepo 根目录</span></span>
<span class="line"><span>npm install</span></span>
<span class="line"><span></span></span>
<span class="line"><span># 构建 TypeScript</span></span>
<span class="line"><span>cd packages/bon-ts</span></span>
<span class="line"><span>npm run build</span></span>
<span class="line"><span></span></span>
<span class="line"><span># 或者全局安装</span></span>
<span class="line"><span>npm install -g bon-ts</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span># 美化输出（默认）</span></span>
<span class="line"><span>bon -p file.bon</span></span>
<span class="line"><span></span></span></code></pre></div><h2 id="命令行参数" tabindex="-1">命令行参数 <a class="header-anchor" href="#命令行参数" aria-label="Permalink to “命令行参数”">​</a></h2><table tabindex="0"><thead><tr><th>参数</th><th>说明</th></tr></thead><tbody><tr><td><code>file</code></td><td>要解析的 .bon 文件</td></tr><tr><td><code>-e, --eval</code></td><td>直接解析 BON 表达式字符串</td></tr><tr><td><code>-p, --pretty</code></td><td>美化输出（默认）</td></tr><tr><td><code>-c, --compact</code></td><td>紧凑输出</td></tr></tbody></table><h2 id="示例" tabindex="-1">示例 <a class="header-anchor" href="#示例" aria-label="Permalink to “示例”">​</a></h2><h3 id="解析简单对象" tabindex="-1">解析简单对象 <a class="header-anchor" href="#解析简单对象" aria-label="Permalink to “解析简单对象”">​</a></h3><div class="language-bash"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes vitesse-light vitesse-dark" style="background-color:#ffffff;--shiki-dark-bg:#121212;color:#393a34;--shiki-dark:#dbd7caee;" tabindex="0"><code><span class="line"><span>bon -e &#39;{ &quot;name&quot;: &quot;BON&quot;, &quot;version&quot;: &quot;1.0&quot; }&#39;</span></span>
...
<span class="line"><span>}</span></span>
<span class="line"><span></span></span></code></pre></div><h2 id="在-typescript-javascript-代码中使用" tabindex="-1">在 TypeScript/JavaScript 代码中使用 <a class="header-anchor" href="#在-typescript-javascript-代码中使用" aria-label="Permalink to “在 TypeScript/JavaScript 代码中使用”">​</a></h2><div class="language-typescript"><button title="Copy Code" class="copy"></button><span class="lang">typescript</span><pre class="shiki shiki-themes vitesse-light vitesse-dark" style="background-color:#ffffff;--shiki-dark-bg:#121212;color:#393a34;--shiki-dark:#dbd7caee;" tabindex="0"><code><span class="line"><span>import { evaluate, load } from &quot;bon-ts&quot;;</span></span>
<span class="line"><span></span></span>
<span class="line"><span>// 解析 BON 表达式</span></span>
<span class="line"><span>const result = evaluate(&#39;{ &quot;name&quot;: &quot;Alice&quot; }&#39;);</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>console.log(result.name); // Alice</span></span>
...
<span class="line"><span></span></span></code></pre></div><h2 id="与-jq-配合" tabindex="-1">与 jq 配合 <a class="header-anchor" href="#与-jq-配合" aria-label="Permalink to “与 jq 配合”">​</a></h2><div class="language-bash"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes vitesse-light vitesse-dark" style="background-color:#ffffff;--shiki-dark-bg:#121212;color:#393a34;--shiki-dark:#dbd7caee;" tabindex="0"><code><span class="line"><span># 格式化输出</span></span>
<span class="line"><span>bon config.bon | jq .</span></span>
<span class="line"><span></span></span>
<span class="line"><span># 提取特定字段</span></span>
<span class="line"><span>bon config.bon | jq &#39;.database.host&#39;</span></span>
<span class="line"><span></span></span>
<span class="line"><span># 过滤数组</span></span>
<span class="line"><span>bon data.bon | jq &#39;.items[] | select(.active == true)&#39;</span></span>
<span class="line"><span></span></span></code></pre></div>`,30)])])}const b=a(l,[["render",t]]);export{h as __pageData,b as default};
