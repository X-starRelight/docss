import{_ as a,o as n,c as p,ak as e}from"./chunks/framework.D8TdBi6N.js";const h=JSON.parse('{"title":"bon-ts 库使用指南","description":"","frontmatter":{},"headers":[],"relativePath":"zh/how-to-use/ts.md","filePath":"zh/how-to-use/ts.md","lastUpdated":1782618872000}'),l={name:"zh/how-to-use/ts.md"};function t(o,s,i,c,r,d){return n(),p("div",null,[...s[0]||(s[0]=[e(`<h1 id="bon-ts-库使用指南" tabindex="-1">bon-ts 库使用指南 <a class="header-anchor" href="#bon-ts-库使用指南" aria-label="Permalink to “bon-ts 库使用指南”">​</a></h1><h2 id="安装" tabindex="-1">安装 <a class="header-anchor" href="#安装" aria-label="Permalink to “安装”">​</a></h2><div class="language-bash"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes vitesse-light vitesse-dark" style="background-color:#ffffff;--shiki-dark-bg:#121212;color:#393a34;--shiki-dark:#dbd7caee;" tabindex="0"><code><span class="line"><span>cd packages/bon-ts</span></span>
